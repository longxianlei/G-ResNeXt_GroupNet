...
__all__ = ['G_ResNext', 'g_resnext50', 'g_resnext101']


def conv3x3(in_planes, out_planes, stride=1, dilation=1):
    """3x3 convolution with padding"""
    return DGConv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=dilation, bias=False, dilation=dilation)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = conv3x3(width, width, stride=stride, dilation=dilation)
...
def g_resnext50(**kwargs):
    ...
    return G_ResNext(Bottleneck, [3, 4, 6, 3], **kwargs)
...
def g_resnext101(**kwargs):
    ...
    return G_ResNext(Bottleneck, [3, 4, 23, 3], kwargs)
